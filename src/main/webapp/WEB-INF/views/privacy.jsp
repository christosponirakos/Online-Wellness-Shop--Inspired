            ...
            <section class="page-section bg-light" id="services">
                <div class="container">
                    <div class="text-center">
                        <h2 class="section-heading text-uppercase">PRIVACY TERMS</h2>
                        <h3 class="section-subheading text-muted"><p>
                            ...
                            <P>User Name</P>
<P>Password<P/>
<P>Other Registration Information</P>


<P>Customer Support or Technical Information you provide when you contact us with questions about your use of the Services
...
Other information you may provide to us through promotions or surveys.</P>
